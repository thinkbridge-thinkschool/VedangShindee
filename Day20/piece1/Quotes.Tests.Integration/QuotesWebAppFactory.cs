...
public sealed class QuotesWebAppFactory : WebApplicationFactory<Program>
{
    ...
    {
        // Clear the Service Bus connection string so ServiceBusExtensions skips
        // registering the client, publisher, and workers entirely.
        // Integration tests exercise HTTP endpoints only — no live Azure connection needed.
