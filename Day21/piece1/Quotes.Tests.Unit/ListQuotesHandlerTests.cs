...
public class ListQuotesHandlerTests
{
    ...
    // The factory lambda is always invoked on a cold miss, preserving the ability
    // to verify repository calls via NSubstitute without mocking HybridCache.
    ...
    public async Task HandleAsync_ReturnsEmptyList_WhenRepositoryReturnsNone()
    {
        ...
        var handler = new ListQuotesHandler(repo, CreateCache());
